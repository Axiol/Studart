        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              ...
              <li class="about <?php if($this->request->controller == "pages" && $this->request->action == "display"){ echo "active"; } ?>"><?php echo $this->Html->link("À Propos",array("controller" => "pages", "action" => "about")); ?></li>
